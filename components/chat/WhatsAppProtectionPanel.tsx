...
export function WhatsAppProtectionPanel({ protection, connected }: Props) {
  ...
  return (
    <div className={`overflow-hidden rounded-xl border border-[var(--border)] ${unavailable || prudence ? "tmw-tone-warning" : "tmw-tone-success"}`}>
      <div className="p-3">
        <div className="flex flex-wrap items-start justify-between gap-2">
          <div className="flex min-w-0 items-start gap-3">
            <div className="tmw-icon-soft flex h-8 w-8 shrink-0 items-center justify-center rounded-[10px]">
          ...
          <span className="shrink-0 rounded-full border border-[var(--border)] bg-[var(--card)]/70 px-2 py-1 text-[11px] font-semibold text-[var(--text-tertiary)]">
            {sourceLabel}
          </span>
        </div>
        ...
        {!unavailable && (
          <div className="mt-4 grid gap-2.5 sm:grid-cols-2">
            {sensitive ? (
              <div className="tmw-inset rounded-xl border border-[var(--border)] p-3">
                <div className="flex items-center justify-between gap-2">
                  ...
                  <span className="text-[11.5px] font-semibold tabular-nums text-[var(--text-primary)]">
        ...
        <div className="mt-3 flex flex-wrap gap-1.5">
          {protection.policies?.anti_duplicate ? (
            <span className="inline-flex items-center gap-1 rounded-full border border-[var(--border)] bg-[var(--card)]/65 px-2 py-1 text-[11px] font-medium text-[var(--text-tertiary)]">
