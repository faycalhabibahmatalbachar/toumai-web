...
const FAQ = [
  {
    ...
    r: "نعم. توماي مساعد ذكاء اصطناعي صُمّم في تشاد، في نجامينا، على يد فيصل حبيب أحمد. يمكن استخدامه مجانًا على toumaiai.com من المتصفّح، وتطبيق أندرويد قيد الإعداد، وهو يفهم العربية والعربية التشادية والفرنسية.",
  },
  {
    q: "هل توماي مجاني؟",
      ...
      <div dir="rtl" lang="ar" className="flex min-h-dvh flex-col">
        ...
        <main className="mx-auto w-full max-w-3xl flex-1 px-4 pb-20 pt-8">
          ...
          <div className="mt-8 space-y-4 text-[16px] leading-loose text-[var(--text-secondary)]">
            ...
            <p>
              المساعد متاح على الويب، ويعمل في متصفّح الهاتف دون تثبيت؛ وتطبيق
              أندرويد قيد الإعداد. لا يطلب بطاقة بنكية ولا
