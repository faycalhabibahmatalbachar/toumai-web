...
Ne pas les grossir. Le garde-fou du script vient d'un essai réel : la seconde
main, nativement à sa taille d'affichage, agrandie « pour uniformiser », passait
de 4 à 28 Ko sans gagner un seul détail. Cette main-là a disparu avec la scène
du code secret, remplacée par celle de la lampe ; le garde-fou reste.
