...
/**
 * Authenticated SSE reader. EventSource cannot attach the Bearer header used by
 * Toumaï, so we keep the one canonical auth/refresh path through authFetch and
 * parse the text/event-stream incrementally.
 */
